namespace TempleLang.Lexer
{
        ...
        where TSourceFile : ISourceFile
    {
        ...
        public override bool Equals(object? obj) => obj is Token<TTokenType, TSourceFile> token
            && Text == token.Text
            && EqualityComparer<TTokenType>.Default.Equals(Type, token.Type)
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = (hashCode * -1521134295) + EqualityComparer<TTokenType>.Default.GetHashCode(Type);
        ...
        public override string ToString() => $"\"{Text}\" {nameof(Type)}.{Type}:{TokenIndex}@{SourceFile}:({FirstCharIndex}-{LastCharIndex})";
    }
}